...
and password='".md5($password)."'";
	...
	echo "<script type='text/javascript'> alert('Username or password is incorrect');location.href='studentregistration.php'</script>";
...
<div class="col-md-10 text-right" style="padding-top:2%">
		...
		<img src="images/stud.jpg" style="width:100%">
	 ...
	 <br><br>
		...
		<p>Not Registered? <a href="signinstudent.php"><strong>SIGN IN</strong></a></span></p>
