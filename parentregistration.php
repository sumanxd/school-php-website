...
<body>
		<?php
			...
			echo "<script type='text/javascript'> alert('Username or password is incorrect'); location.href='parentregistration.php'</script>";
	...
	<div class="col-md-10 text-right" style="padding-top:2%">
			...
			<img src="images/13.jpg" style="width:100%;height:56%">
		
	<section>
			<br><br>
			<div class="col-md-8" >
				<h2>Parent's Corner</h2>
				<p style="font-size:16px;text-align:justify">Azra’s philosophy is founded on the belief that education is about
				fun-filled learning, enjoyable and relevant to today’s world, while unleashing the creative potential of the child.
				Learning at our School is child-centered and growth oriented.</p>
			...
			<div class="col-md-4">
				...
				<p>Not Registered? <a href="signinparent.php"><strong>SIGN IN</strong></a></span></p>			
			</div>
		<?php } ?>
	</section>
