	...
	<div class="container-fluid"  >
	 ...
	 <div class="row" style="margin-top:40px;overflow:hidden;">
					<ul class="nav nav-pills" style="overflow:hidden;border:2px solid blue;font-size:21px;text-transform:uppercase;font-family:roboto;background-color:lightgreen;border-top-left-radius:25px;border-top-right-radius:25px;overflow:hidden;">
						...
						<li ><a href="#clients" data-toggle="tab" style="color:white;     margin-left: 391px;"><strong>View Assignments</strong></a></li>
						<li ><a href="#assign" data-toggle="tab" style="color:white;"><strong>Submit Assignments</strong></a></li>
					</ul>
							...
							<div class="contentform in">
								...
								<div class="leftcontact">
									...
									<span class="icon-case"><i class="fa fa-id-badge"></i></span>
										<input type="text" name="class" id="society" placeholder="Class Id no" required data-msg="Vérifiez votre saisie sur les champs : Le champ 'Société' doit être renseigné."/>
										
									</div>										
									<div class="form-group">
									<p>  <span></span></p>
									<span class="icon-case"><i class="fa fa-id-badge"></i></span>
										<input type="text" name="subject" id="society" placeholder="Subject Name" required data-msg="Vérifiez votre saisie sur les champs : Le champ 'Société' doit être renseigné."/>
										
									</div>																		
									<div class="form-group">
									<p>  <span></span></p>
									<span class="icon-case"><i class="fa fa-pencil"></i></span>
										<input type="text" name="topic" id="society1"  placeholder="Topic Name" data-rule="required" data-msg="Vérifiez votre saisie sur les champs : Le champ 'Société' doit être renseigné."/>
									...
									<div class="">
										...
										<div class="image-upload">
										  <label for="file-input">
											<img src="http://s3.postimg.org/mjzvuzi5b/uploader_image.png"  width="50%"/>
										  </label>
