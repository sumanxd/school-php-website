...
VALUES ('$username','$roll','$phone','$csection','".md5($password)."', '$email', '$trn_date')";
        ...
        if($result){
           echo "<script type='text/javascript'> alert('Registered Successfully');location.href='studentregistration.php'</script>";
        }
    }else{
?>
				<div class="container-fluid">
					...
					<p>Student Name<span style="color:red">*</span></p>
					...
					<p>Enroll No.<span style="color:red">*</span></p>
					<span class="icon-case">
