	...
	<div class="icons">
		...
		<i class="fa fa-pinterest-square" aria-hidden="true" style=" float:right;"></i>
			...
			<section>
				...
				<section>
					<img src="images/azra2.jpg" height="200px" width="100%">
				</section>
				
				
				
	<div class="container">
		<h1 style="text-align:center;"> Teacher Page</h1>
			<div class="row" style="margin-top:40px;overflow:hidden;">
					<ul class="nav nav-pills" style="overflow:hidden;border:2px solid blue;font-size:21px;text-transform:uppercase;font-family:roboto;background-color:lightgreen;border-top-left-radius:25px;border-top-right-radius:25px;overflow:hidden;" id="tabs">
						...
						<li ><a href="#" name="tab1" style="color:white;margin-left: 173px;"><strong>Add Assignments</strong></a></li>
						<li ><a href="#" name="tab2" style="color:white;"><strong>View Assignments</strong></a></li>
						<li ><a href="#" name="tab3" style="color:white;"><strong>Submitted Assignments</strong></a></li>
					</ul>
			...
			<div class="container" style="margin-left:200px;">
										  ...
										  <form action="upload.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()"  id="myfrm1">
...
<input name="topic" type="text" placeholder="Topic Name" required>		
		...
		<div class="image-upload">
		  ...
		  <input id="file-input" type="file" name="file" required/>
									...
									<p> <span></span></p>
										...
										<textarea name="message" rows="14" placeholder="Comment Box" data-rule="required" data-msg="Vérifiez votre saisie sur les champs : Le champ 'Message' doit être renseigné." required></textarea>
...
<option name="class">1</option>
 ...
 <input type="submit" class="button button2" style="margin-left: 519px;" name="submit" value="Submit"/>
</form>
...
$fetch="SELECT class,subject,topic,date,file FROM tbl_uploadsnew WHERE class = '".$name."' LIMIT 0, 30 ";
...
echo "Error:".(mysqli_error($con));
							...
							while($data=mysqli_fetch_assoc($result))  
							{
								...
								<td><a href="studentupload/<?php echo $data['file'] ?>" target="_blank">view file</a></td>
								</tr>
								<?php
